...
{
    IDLE=0,              
    CAL_ACID_SUCCESS,          /* 1, ������ҺУ׼�ɹ� */
	  CAL_ALKALI_ORP_SUCCESS,    /* 2, pH:������ҺУ׼�ɹ���ORP:orpУ׼�ɹ� */
	  STD_VALUE_ERR,             /* 3, δ�������ֵ��������ı���ֵ����У׼��Χ */
		RESULT_ERR,				         /* 4, У׼��Ĳ��������� */
	  STD_TYPE_ERR,              /* 5, ��Һֵ�������ʹ��� */
	  CAL_PH7_SUCCESS            /* 6, ����У׼��ԭ�㣬PH7У׼�ɹ� */
} CalibState;
...
{											/* Register		Type  		 R/W */
	uint16		runStatus;					/* 41001 */
	uint16   	commStatus;					/* 41002 */
	uint16 		calibStatus;				/* 41003 	 0�����У�1��дpH��A���Һֵ�ɹ���2��У׼�ɹ���3����Һֵ��С��������4��У׼�����������5����Һֵ�Ƿ������� */
	uint16		configStatus;				/* 41004 */
...
{											          /* Register		Type  		     R/W  */	
	...
	uint16    usAutoGain;         //自动量程关闭/开启
	uint16    usAutoSAT;          //自动切换量程饱和值
	uint16    usGain1T365;        //倍数1的T365
	uint16    usGain2T365;        //倍数2的T365
